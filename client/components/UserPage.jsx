...
const UserPage= () => {
    ...
    return (
        <div className="box">
            ...
            <div>
                <h3>Alex Honnold</h3>
                <p>5 miles awayJust All my hiking partners retired or have passed away. Looking for people willing to free solo with me.
                Contact me at alexhonnold@gmail.com</p>
            </div>
            <div>
